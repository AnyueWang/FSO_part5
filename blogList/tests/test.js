...
describe('favorite blog', () => {
    ...
    test('of only one blog is that blog', () => {
...
describe('author with most blogs', () => {
    test('among an empty list is none', () => {
        const result = listHelper.mostBlogs([])
        assert.deepStrictEqual(result, {})
    })
    test("among only one blog is that blog's author", () => {
    ...
    test('among more blogs is the one with most blogs', () => {
...
describe('author with most likes', () => {
    ...
    test('among more blogs is the one with most likes', () => {
